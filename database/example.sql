...
ALTER TABLE Group ADD CONSTRAINT pkGroups PRIMARY KEY (Id);
...
ALTER TABLE Users ADD CONSTRAINT fkUserGroup FOREIGN KEY (GroupId) REFERENCES Session (Id) ON DELETE RESTRICT;
...
CREATE UNIQUE INDEX akSessions ON Session (SID);
